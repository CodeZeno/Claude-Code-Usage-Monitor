...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_menu_item: "Antigravity instellen...",
    antigravity_setup_title: "Antigravity instellen",
    antigravity_setup_intro: concat!(
        "Het Antigravity-gebruik wordt uitgelezen via de eigen statusregelfunctie van de Antigravity CLI. ",
        "Deze app leest uw Google-accountgegevens niet en heeft geen rechtstreeks contact met Google.\n\n",
        "1. Open de Antigravity CLI.\n",
        "2. Voer de onderstaande opdracht uit.\n",
        "3. Gebruik Antigravity zoals gewoonlijk — uw gebruik verschijnt hier automatisch."
    ),
    antigravity_setup_command_label: "Uit te voeren opdracht (naar klembord gekopieerd):",
    antigravity_setup_disable_label: "Om dit later te verwijderen, voer uit:",
    antigravity_last_observed_label: "Laatst waargenomen: ",
    antigravity_never_observed: "Er is nog geen Antigravity-gebruik waargenomen.",
