...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Meldingen",
    notifier_sms: "SMS",
    notifier_email: "E-mail",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "WhatsApp activeren",
    notifier_whatsapp_opted_in: "(geactiveerd)",
    notifier_test: "Melding testen",
    notifier_open_config: "Configuratiebestand openen",
    notifier_reload: "Configuratie herladen",
    second_suffix: "s",
};
