...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Notificaciones",
    notifier_sms: "SMS",
    notifier_email: "Correo",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "Activar WhatsApp",
    notifier_whatsapp_opted_in: "(activado)",
    notifier_test: "Probar notificacion",
    notifier_open_config: "Abrir archivo de configuracion",
    notifier_reload: "Recargar configuracion",
    second_suffix: "s",
};
