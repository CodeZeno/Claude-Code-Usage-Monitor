...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_intro: concat!(
        "El uso de Antigravity se lee mediante la propia función de barra de estado de la CLI de Antigravity. ",
        "Esta aplicación no lee las credenciales de su cuenta de Google ni contacta con Google directamente.\n\n",
        "1. Abra la CLI de Antigravity.\n",
        "2. Ejecute el comando siguiente.\n",
        "3. Use Antigravity con normalidad: su uso aparecerá aquí automáticamente."
    ),
    antigravity_setup_command_label: "Comando a ejecutar (copiado al portapapeles):",
    antigravity_setup_disable_label: "Para eliminarlo más adelante, ejecute:",
    antigravity_last_observed_label: "Última observación: ",
    antigravity_never_observed: "Aún no se ha observado ningún uso de Antigravity.",
    ...
    virtual_desktop_scope: "Escritorio virtual",
    virtual_desktop_scope_all: "Todos los escritorios",
    virtual_desktop_scope_current_only: "Solo este escritorio",
};
