...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_menu_item: "Antigravity 設定...",
    antigravity_setup_title: "Antigravity 設定",
    antigravity_setup_intro: concat!(
        "Antigravity 的用量是透過 Antigravity CLI 自帶的狀態列功能讀取。",
        "此應用程式不會讀取您的 Google 帳戶憑證，也不會直接連線至 Google。\n\n",
        "1. 開啟 Antigravity CLI。\n",
        "2. 執行下方指令。\n",
        "3. 正常使用 Antigravity —— 用量將自動顯示於此。"
    ),
    antigravity_setup_command_label: "要執行的指令（已複製到剪貼簿）：",
    antigravity_setup_disable_label: "之後若要移除，請執行：",
    antigravity_last_observed_label: "最近一次觀測：",
    antigravity_never_observed: "尚未觀測到任何 Antigravity 用量。",
