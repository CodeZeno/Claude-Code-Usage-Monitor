...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Уведомления",
    notifier_sms: "SMS",
    notifier_email: "Эл. почта",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "Включить WhatsApp",
    notifier_whatsapp_opted_in: "(включено)",
    notifier_test: "Проверить уведомление",
    notifier_open_config: "Открыть файл конфигурации",
    notifier_reload: "Перезагрузить конфигурацию",
    second_suffix: "с",
};
