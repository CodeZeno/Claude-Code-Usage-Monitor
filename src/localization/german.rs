...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_menu_item: "Antigravity einrichten...",
    antigravity_setup_title: "Antigravity einrichten",
    antigravity_setup_intro: concat!(
        "Die Antigravity-Nutzung wird über die eigene Statuszeilenfunktion der Antigravity-CLI gelesen. ",
        "Diese App liest Ihre Google-Kontoanmeldedaten nicht und kontaktiert Google nicht direkt.\n\n",
        "1. Öffnen Sie die Antigravity-CLI.\n",
        "2. Führen Sie den folgenden Befehl aus.\n",
        "3. Verwenden Sie Antigravity wie gewohnt — Ihre Nutzung erscheint hier automatisch."
    ),
    antigravity_setup_command_label: "Auszuführender Befehl (in die Zwischenablage kopiert):",
    antigravity_setup_disable_label: "Um dies später zu entfernen, führen Sie aus:",
    antigravity_last_observed_label: "Zuletzt beobachtet: ",
    antigravity_never_observed: "Es wurde noch keine Antigravity-Nutzung beobachtet.",
    ...
    virtual_desktop_scope: "Virtueller Desktop",
    virtual_desktop_scope_all: "Alle Desktops",
    virtual_desktop_scope_current_only: "Nur dieser Desktop",
};
