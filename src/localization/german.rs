...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Benachrichtigungen",
    notifier_sms: "SMS",
    notifier_email: "E-Mail",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "WhatsApp aktivieren",
    notifier_whatsapp_opted_in: "(aktiviert)",
    notifier_test: "Benachrichtigung testen",
    notifier_open_config: "Konfigurationsdatei öffnen",
    notifier_reload: "Konfiguration neu laden",
    second_suffix: "s",
};
