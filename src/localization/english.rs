...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_whatsapp_optin: "Opt in to WhatsApp",
    notifier_whatsapp_opted_in: "(opted in)",
    notifier_test: "Test notification",
    notifier_open_config: "Open config file",
    notifier_reload: "Reload config",
    second_suffix: "s",
};
