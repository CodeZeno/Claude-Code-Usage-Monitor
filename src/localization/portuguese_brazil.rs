...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_menu_item: "Configurar Antigravity...",
    antigravity_setup_title: "Configurar Antigravity",
    antigravity_setup_intro: concat!(
        "O uso do Antigravity é lido através do próprio recurso de barra de status da CLI do Antigravity. ",
        "Este aplicativo não lê suas credenciais da conta do Google nem contata o Google diretamente.\n\n",
        "1. Abra a CLI do Antigravity.\n",
        "2. Execute o comando abaixo.\n",
        "3. Use o Antigravity normalmente — seu uso aparecerá aqui automaticamente."
    ),
    antigravity_setup_command_label: "Comando a executar (copiado para a área de transferência):",
    antigravity_setup_disable_label: "Para removê-lo depois, execute:",
    antigravity_last_observed_label: "Última observação: ",
    antigravity_never_observed: "Nenhum uso do Antigravity foi observado ainda.",
    ...
    virtual_desktop_scope: "Área de trabalho virtual",
    virtual_desktop_scope_all: "Todas as áreas de trabalho",
    virtual_desktop_scope_current_only: "Somente esta área de trabalho",
};
