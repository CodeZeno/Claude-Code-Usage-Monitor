...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Notificações",
    notifier_sms: "SMS",
    notifier_email: "E-mail",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "Ativar WhatsApp",
    notifier_whatsapp_opted_in: "(ativado)",
    notifier_test: "Testar notificação",
    notifier_open_config: "Abrir arquivo de configuração",
    notifier_reload: "Recarregar configuração",
    second_suffix: "s",
};
