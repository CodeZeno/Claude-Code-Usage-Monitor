...
pub(super) const STRINGS: Strings = Strings {
    ...
    notifier_menu: "Notifications",
    notifier_sms: "SMS",
    notifier_email: "E-mail",
    notifier_whatsapp: "WhatsApp",
    notifier_whatsapp_optin: "Activer WhatsApp",
    notifier_whatsapp_opted_in: "(active)",
    notifier_test: "Tester la notification",
    notifier_open_config: "Ouvrir le fichier de configuration",
    notifier_reload: "Recharger la configuration",
    second_suffix: "s",
};
