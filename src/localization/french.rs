...
pub(super) const STRINGS: Strings = Strings {
    ...
    antigravity_setup_menu_item: "Configuration d'Antigravity...",
    antigravity_setup_title: "Configuration d'Antigravity",
    antigravity_setup_intro: concat!(
        "L'utilisation d'Antigravity est lue via la fonction de barre d'état propre à la CLI Antigravity. ",
        "Cette application ne lit pas vos identifiants de compte Google et ne contacte jamais Google directement.\n\n",
        "1. Ouvrez la CLI Antigravity.\n",
        "2. Exécutez la commande ci-dessous.\n",
        "3. Utilisez Antigravity normalement — votre utilisation apparaîtra ici automatiquement."
    ),
    antigravity_setup_command_label: "Commande à exécuter (copiée dans le presse-papiers) :",
    antigravity_setup_disable_label: "Pour la supprimer plus tard, exécutez :",
    antigravity_last_observed_label: "Dernière observation : ",
    antigravity_never_observed: "Aucune utilisation d'Antigravity n'a encore été observée.",
    ...
    virtual_desktop_scope: "Bureau virtuel",
    virtual_desktop_scope_all: "Tous les bureaux",
    virtual_desktop_scope_current_only: "Ce bureau uniquement",
};
