...
pub struct Strings {
    ...
    pub antigravity_setup_menu_item: &'static str,
    pub antigravity_setup_title: &'static str,
    pub antigravity_setup_intro: &'static str,
    pub antigravity_setup_command_label: &'static str,
    pub antigravity_setup_disable_label: &'static str,
    pub antigravity_last_observed_label: &'static str,
    pub antigravity_never_observed: &'static str,
